    ...
    <div class="flex flex-col flex-1 items-center">
        ...
        <div class="flex flex-col items-center text-white py-12" v-if="weatherData">
            ...
            <div class="text-center">
                ...
                <img class="w-[150px] h-auto" :src="`https://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}@2x.png`" alt="weather icon">
            </div>
        </div>
        <!-- Other parts of your template remain the same -->
    </div>
</template>
...
const getWeatherData = async () => {
    try {
        const response = await axios.get(
            `https://api.openweathermap.org/data/2.5/onecall?lat=33.705256&lon=-7.396708&exclude=minutely,hourly&appid=53e22a5cc1be701762afe165bf5f3998&units=imperial`
        );
        ...
        // Update hourly weather time offsets
